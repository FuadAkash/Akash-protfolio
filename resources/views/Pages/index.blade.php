...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Akash</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        <li class="nav-item"><a class="nav-link" href="{{route('login')}}">Backend</a></li>
        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Worked with dignity</h3>
                </div>
                            ...
                            <!-- Portfolio item 1-->
                                <div class="portfolio-item">
                                    <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal<?php echo $protfolio->id?>">
                                        ...
                                        <img class="img-fluid" src="{{url($protfolio->small_image)}}" alt="..." />
                                    </a>
                                    <div class="portfolio-caption">
                                        <div class="portfolio-caption-heading">{{$protfolio->title}}</div>
                                        <div class="portfolio-caption-subheading text-muted">{{$protfolio->sub_title}}</div>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                            ...
                            <li>
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <h4>{{$about->title}}</h4>
                                        <h4 class="subheading">{{$about->title_1}}</h4>
                                    </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 text-lg-end">
                        <a class="link-dark text-decoration-none me-3" href="{{route('admin.main')}}">Privacy Policy</a>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <img class="img-fluid d-block mx-auto" src="{{url($protfolio->big_image)}}" alt="..." />
                                    ...
                                    <ul class="list-inline">
                                        ...
                                        <li>
                                            <strong>Date:</strong>
                                            {{$protfolio->created_at->toDateString()}}
                                        </li>
                                        <li>
                                            <strong>Updated:</strong>
                                            {{$protfolio->updated_at->toDateString()}}
                                        </li>
                                    </ul>
