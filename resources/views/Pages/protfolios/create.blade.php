            ...
            <form action="{{route('admin.protfolios.store')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="from-group col-md-3 mt-3" >
                        <h3>Big Image</h3>
                        <img style="height: 30vh" src="{{secure_asset('assets/img/big_image.png')}}" class="img-thumbnail">
                        <input class="mt-3" type="file" name="big_image">
                    </div>
                    <div class="from-group col-md-3 mt-3" >
                        <h3>Small Image</h3>
                        <img style="height: 30vh" src="{{secure_asset('assets/img/small_image.png')}}" class="img-thumbnail">
